        ...
        <div class="container margin_120_100 home_intro">
            <div class="row justify-content-center d-flex align-items-center">
                <div class="col-lg-5 text-lg-center d-none d-lg-block" data-cue="slideInUp">
                    <figure>
                        <img src="{{ asset("assets/frontend/img/home_1_placeholder.png") }}"
                             data-src="{{ asset("assets/frontend/img/home_1.jpg") }}" width="354" height="440"
                ...
                <div class="col-lg-5 pt-lg-4" data-cue="slideInUp" data-delay="500">
                    ...
                    <p><img src="{{ asset("assets/frontend/img/signature.png") }}" width="140" height="50" alt=""
                            class="mt-3"></p>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-5 col-md-6 text-center">
                        <div class="call_section_img" data-cue="slideInUp">
                            <img src="{{ asset("assets/frontend/img/bg_call_section.jpg") }}" alt="call"
                                 class="img-fluid">
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="submit step">
                                        ...
                                        <div class="form-group terms">
                                            <label class="container_check">Please accept our <a href="#"
                                                                                                ...
                                                                                                data-bs-target="#terms-txt">Terms
                                                    and
                                                    conditions</a>
