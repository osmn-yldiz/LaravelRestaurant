                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        @if($category->thumbnail)
                            <img src="{{ $category->thumbnail }}" alt="{{ $category->name }}" width="80">
                        @else
                            <img width="100" src="{{ asset('/uploads/category/no-image.jpg') }}" alt="No Image">
                        @endif
                    </div>
                </div>
                <fieldset class="form-group">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="type" id="blog"
                                       value="1" {{ $category->type == 1 ? 'checked' : '' }}>
