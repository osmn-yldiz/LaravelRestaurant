                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-6">
                                                    <img src="{{asset('assets/frontend/img/icon_ccv.gif')}}" width="50" height="29"
                                                         alt="ccv"><small>Last
                                                        3 digits</small>
                                                </div>
                                            </div>
                            ...
                            <div class="main">
                                <ul class="clearfix">
                                    @foreach($carts as $cart)
                                        ...
                                        <li><a href="#0">{{ $cart->quantity }}
                                                x {{ $cart->menu->title }}</a><span>${{ $cart->quantity * $cart->menu->price }}</span>
                                        </li>
                                    @endforeach
                                </ul>
                                ...
                                <ul class="clearfix">
                                    ...
                                    <li class="total">
                                        Total<span>${{ $general ? ($general->delivery_fee + $subTotal) : $subTotal }}</span>
                                    </li>
                                    <input type="hidden" name="total"
                                           value="{{ $general ? ($general->delivery_fee + $subTotal) : $subTotal }}">
                                </ul>
                                <button type="submit" class="btn_1 full-width mb_5">Order Now</button>
                                <div class="text-center"><small>Or Call Us at
                                        <strong>{{ $general ? $general->primary_phone : '' }}</strong></small>
                                </div>
                            </div>
                        </div>
                    </div>
